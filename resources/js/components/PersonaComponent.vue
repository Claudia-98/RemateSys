                                ...
                                <tr v-for="categoria in arrayPersona" :key="categoria.id">
                                    <td>
                                        ...
                                        <template v-if="categoria.estado">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarPersona(categoria.id)">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarPersona(categoria.id)">
        ...
        methods : {
            ...
            desactivarPersona(id){
               Swal.fire({
                ...
                text: "¿Esta seguro de desactivar este proveedor?",
                icon: 'warning',
                ...
                if (result.value) {
                    ...
                    axios.put('/persona/desactivar',{
                        ...
                        Swal.fire(
                        'Desactivado!',
                        'El proveedor ha sido desactivada con éxito.',
                        'success'
                        )
                    }).catch(function (error) {
                        console.log(error);
            ...
            activarPersona(id){
               Swal.fire({
                ...
                text: "¿Esta seguro de activar este proveedor?",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
